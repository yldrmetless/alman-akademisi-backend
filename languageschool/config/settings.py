...
db_options = {"sslmode": "require"} if DEBUG else {}
...
STATIC_URL = "static/"
STATIC_ROOT = BASE_DIR / "staticfiles" # Hostinger'da collectstatic için gerekli

# Media files (User uploaded files: PDF, Product Images, etc.)
MEDIA_URL = "/media/"
